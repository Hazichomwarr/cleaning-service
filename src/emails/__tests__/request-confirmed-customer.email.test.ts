...
test("renders committed confirmation facts and business-time appointment", () => {
  const html = renderRequestConfirmedCustomerEmail({ requestNumber: "JC-2026-0001", customerName: "Jane <script>alert(1)</script>", serviceName: "Deep Cleaning", propertyType: "HOUSE", bedrooms: 2, bathrooms: "1.5", confirmedPrice: "250.00", scheduledTime: "Aug 18, 2026 · 10:00 AM", addressLine1: "123 Main <Street>", addressLine2: null, city: "Newark", state: "NJ", postalCode: "07102", extraNames: ["Inside <Oven>"] });
...
test("omits extras when none were selected", () => {
  const html = renderRequestConfirmedCustomerEmail({ requestNumber: "JC-2026-0001", customerName: null, serviceName: "Office Cleaning", propertyType: "OFFICE", bedrooms: null, bathrooms: null, confirmedPrice: "650.00", scheduledTime: "Aug 18, 2026 · 10:00 AM", addressLine1: "1 Main", addressLine2: null, city: "Newark", state: "NJ", postalCode: "07102", extraNames: [] });
